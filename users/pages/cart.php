...
<div class="space-y-6 relative pb-28 lg:pb-0">
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto flex items-center gap-3">
            <?php if (empty($cart)): ?>
                <a href="index.php?page=home"
                    class="w-full inline-flex items-center justify-center gap-2 bg-gold text-black px-6 py-3 rounded-xl font-bold shadow-[0_4px_14px_0_rgba(212,175,55,0.39)] hover:bg-yellow-400 transition-all duration-300">
                    Belanja Sekarang
